...
function hideCurrentQuestion() {
  ...
  document.getElementById(
    localStorage.getItem("appointmentPrep.currentQuestionId")
  ).style.display = "none";
...
function showNextQuestion() {
  ...
  var currentQuestionDiv = document.getElementById(
  ...
  localStorage.setItem(
    "appointmentPrep.currentQuestionId",
...
/*
    ...
    sensitive to when its called; call this only *after* questions have been 
    shown and localStorage has been updated
    */
  ...
  for (var i = 0; i < myselect.options.length; i++) {
    if (myselect.options[i].selected == true) {
      ...
      document.getElementById("span1").innerHTML =
        " <i class='fas fa-diagnoses rspacer'></i>" + answer;
      break;
    }
  }
}
